    ...
    if (this.props.layout === 'horizontal') {
      ...
      mainContent = (
        <div className="navbar-content sidenav-horizontal" id="layout-sidenav">
          <a href={demo} className={prevClass.join(' ')} onClick={this.scrollPrevHandler}><span /></a>
          ...
          <a href={demo} className={nextClass.join(' ')} onClick={this.scrollNextHandler}><span /></a>
        </div>
      );
    } else {
      mainContent = (
...
const mapDispatchToProps = dispatch => {
  return {
    onNavContentLeave: () => dispatch(navContentLeave),
  }
};
