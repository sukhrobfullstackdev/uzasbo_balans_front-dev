...
const orgHeaderInfoSlice = createSlice({
    name: "organizationHeaderInfo",
    initialState,
    reducers: {
...
} = orgHeaderInfoSlice.actions;

// Reducer
const orgHeaderInfoListReducer = orgHeaderInfoSlice.reducer;
export default orgHeaderInfoListReducer;