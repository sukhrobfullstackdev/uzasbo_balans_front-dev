...
const formaDKPositionSlice = createSlice({
    name: "formaDKPositionCanEdit",
    initialState,
    reducers: {
...
} = formaDKPositionSlice.actions;

// Reducer
const formaDKPositionListReducer = formaDKPositionSlice.reducer;
export default formaDKPositionListReducer;