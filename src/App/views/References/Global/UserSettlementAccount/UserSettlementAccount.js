...
const UserSettlementAccount = () => {
    const { t } = useTranslation();
    const location = useLocation();
    const [filterForm] = Form.useForm();
    const dispatch = useDispatch();
    const tableList = useSelector((state) => state.UserSettlementAccountList);
                ...
                <Fade>
                    ...
                    >
                        <div className="main-table-filter-wrapper">
                            ...
                            >
                                <Input
                                    placeholder={t("OrganizationsSettlementAccountID")}
                                    enterButton
                                    onChange={filterTypeHandler}
                                    onSearch={onSearch}
                                />
...
export default UserSettlementAccount;