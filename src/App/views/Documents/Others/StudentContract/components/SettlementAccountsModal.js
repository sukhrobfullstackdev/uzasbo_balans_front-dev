...
const SettlementAccountsModal = (props) => {
    // console.log(props);
    ...
    const fetchData = async () => {
        const [tableData] = await Promise.all([
            HelperServices.getSettlementAccountsList({
                Name: Name,
...
export default React.memo(SettlementAccountsModal);