...
const PaymentRegister = ({ match }) => {
    const { t } = useTranslation();
    const dispatch = useDispatch();
    const [filterForm] = Form.useForm();
    const location = useLocation();

    const reduxList = useSelector((state) => state.paymentRegisterList);
    ...
    const [OrganizationAccountID, setOrganizationAccountID] = useState(0);
                        ...
                        <div className="main-table-filter-elements">
                            ...
                            >
                                <Select
                                    ...
                                    onChange={e => setOrganizationAccountID(e)}
                                >
                            ...
                            <Form.Item>
                                <Button type="primary" disabled={!OrganizationAccountID}>
                                    <Link
                                        to={`${location.pathname}/add?id=0&OrganizationAccountID=${OrganizationAccountID}`}
                                    >
                                        {t("add-new")}&nbsp;
...
export default React.memo(PaymentRegister);