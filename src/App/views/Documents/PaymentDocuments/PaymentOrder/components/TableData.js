...
const TableData = ({ tableData, total, match, reduxList, OrganizationsSettlementAccountID }) => {
    ...
    const printByType = (e, id) => {
        loading = true;
        PaymentOrderServices.printType(id, e.key)
            .then((res) => {
                if (res.status === 200) {
                    loading = false;
    ...
    function postLoadKey(id, vo, reload) {
        ...
        window.CAPIWS.callFunction({
            ...
            if (data.success) {
                ...
                PaymentOrderServices.postSignedData(signData)
                    .then(res => {
                        if (res.status === 200) {
    ...
    const showSendModal = (id) => {
        ...
        confirm({
            ...
            onOk: () => {
                ...
                PaymentOrderServices.getHash(id)
                    .then(res => {
                        if (res.status === 200) {
    ...
    const acceptHandler = (id) => {
        confirm({
            ...
            onOk: () => {
                setTableLoading(true);
                PaymentOrderServices.Accept(id, dateOfAcception)
                    .then((res) => {
                        if (res.status === 200) {
    ...
    const cancelHandler = (id) => {
        confirm({
            ...
            onOk: () => {
                setTableLoading(true);
                PaymentOrderServices.cancel(id)
                    .then((res) => {
                        if (res.status === 200) {
                            Notification('success', t('success-msg'));
                            setTableLoading(false);
    ...
    const prepareToSendHandler = (id) => {
        confirm({
            ...
            onOk: () => {
                setTableLoading(true);
                PaymentOrderServices.prepareForSend(id)
                    .then((res) => {
                        if (res.status === 200) {
                            Notification('success', t('success-msg'));
                            setTableLoading(false);
    ...
    const changeFinYearHandler = (id) => {
        confirm({
            ...
            onOk: () => {
                setTableLoading(true);
                PaymentOrderServices.changeFinYear(id)
                    .then((res) => {
                        if (res.status === 200) {
                            Notification('success', t('success-msg'));
                            setTableLoading(false);
    ...
    const deleteModalHandler = (id) => {
        confirm({
            ...
            onOk: () => {
                setTableLoading(true);
                PaymentOrderServices.delete(id)
                    .then((res) => {
                        if (res.status === 200) {
                            Notification('success', t('success-msg'));
                            setTableLoading(false);
