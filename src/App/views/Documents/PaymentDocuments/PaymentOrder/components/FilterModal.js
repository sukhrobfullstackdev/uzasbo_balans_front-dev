                ...
                <Row gutter={[15, 0]}>
                    ...
                    <Col xl={6} md={12}>
                        <Form.Item
                            ...
                            <InputNumber placeholder={t("INN")} style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
                    <Col xl={6} md={12}>
                        <Form.Item
                            ...
                            <InputNumber placeholder={t("SalaryTransaction")} style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
                    <Col xl={6} md={12}>
                        <Form.Item
                    ...
                    <Col xl={6} md={12}>
                        <Form.Item
                            ...
                            <InputNumber placeholder={t("itemOfExpenseCode")} style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
                    <Col xl={6} md={12}>
                        <Form.Item
                            label={t("PayeeSettlement")}
                            name="PayeeSettlement"
                            style={{ width: "100%" }}
                            rules={[
                                {
                                    required: false,
                            ...
                            <InputNumber placeholder={t("PayeeSettlement")} style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
                    <Col xl={6} md={12}>
                        <Form.Item
