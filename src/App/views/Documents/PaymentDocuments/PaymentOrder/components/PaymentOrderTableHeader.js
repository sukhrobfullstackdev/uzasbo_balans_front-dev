...
const PaymentOrderTableHeader = (props) => {
    ...
    const addStaffHandler = () => {
        let subAccCode = props.mainForm.getFieldValue(['AllowedTransactionID'])
        let subAccountCode = props.subAccountCode;
        let currrrr = props.currrrr;
        const _daxod = props.mainForm.getFieldValue(['IncomeSettlementAccount'])
        ...
        addStaffForm.validateFields()
            .then(values => {
                props.mainForm.validateFields().then(mainValues => {
                    ...
                    if (!!_daxod) {
                        let daxod = _daxod.substring(16, 7)
                        if ((subAccCode === 121 || subAccCode === 122 || subAccCode === 342) && (itemCode === '4111100' || itemCode === '4111210' || itemCode === '4711120') && (daxod === '3131204' || daxod === '3131101') && (subAccountCode.substring(0, 5) === '22634' || subAccountCode.substring(0, 5) === '22636' || subAccountCode.substring(0, 5) === '22638')) {
                            Notification('error', 'PaymentOrderError')
                        }
                    }

                    if ((subAccCode === 121 || subAccCode === 122 || subAccCode === 342) && (itemCode === '4111100' || itemCode === '4111210' || itemCode === '4711120') && (subAccountCode.substring(0, 5) === '22634' || subAccountCode.substring(0, 5) === '22636' || subAccountCode.substring(0, 5) === '22638')) {
                        Notification('error', 'PaymentOrderError')
                    }
