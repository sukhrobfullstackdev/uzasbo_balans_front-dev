...
import { largerMainTableDate, initialMainTablePagination } from "../../../../../../helpers/helpers";
  ...
  reducers: {
    ...
    setListPagination: (state, action) => {
      state.paginationData = {
        ...
        // OrganizationsSettlementAccountID: action.payload?.OrganizationsSettlementAccountID ? action.payload.OrganizationsSettlementAccountID : 
      }
    },
...
// Reducer
const inPaymentReducer = getListSlice.reducer;
export default inPaymentReducer;