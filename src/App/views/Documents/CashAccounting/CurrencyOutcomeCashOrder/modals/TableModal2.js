...
const TableModal = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await ApiServices.get(`${props.subDepartmentList?.DbSubCountInfo?.SubCount2Controller}/${props.subDepartmentList?.DbSubCountInfo?.SubCount2Action}?PageNumber=1&PageLimit=10`);
      ...
      }, [props.subDepartmentList?.DbSubCountInfo?.SubCount2Controller, props.subDepartmentList?.DbSubCountInfo?.SubCount2Action]);
