...
import { Form, Button, DatePicker, Select, Spin, Tooltip } from "antd";
...
const CurrencyOutcomeCashOrder = () => {
  ...
  return (
    <Spin size='large' spinning={mainLoader}>
      <Card title={t("CurrencyOutcomeCashOrder")}>
        <Fade>
          <Form
            layout='vertical'
            form={filterForm}
...
export default CurrencyOutcomeCashOrder;