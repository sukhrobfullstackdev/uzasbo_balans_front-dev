...
import classes from "../IncomeCashOrder.module.css"
...
const StaffTableHeader = (props) => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [addStaffForm, props.modalLink, props.doc, props.data]);
  ...
  const addStaffHandler = () => {
    addStaffForm.validateFields()  
      .then(values => {
        ...
        values.SubCountCr1OriginalID = subCountCr1OriginalID ? subCountCr1OriginalID : 0;
        values.SubCountCr2OriginalID = subCountCr2OriginalID ? subCountCr2OriginalID : 0;
