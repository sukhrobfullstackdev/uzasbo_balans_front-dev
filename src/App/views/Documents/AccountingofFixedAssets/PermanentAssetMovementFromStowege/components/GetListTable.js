...
const GetListTable = () => {
  ...
  const tableList = useSelector((state) => state.PermanentAssetMovementFromStowegeList);
  ...
  const deleteRowHandler = id => {
    setLoading(true);
    PermanentAssetMovementFromStowegeServices.delete(id)
      .then(res => {
        if (res.status === 200) {
  ...
  const acceptHandler = (id) => {
    setLoading(true);
    PermanentAssetMovementFromStowegeServices.Accept(id)
      .then((res) => {
        if (res.status === 200) {
  ...
  const declineHandler = (id) => {
    setLoading(true);
    PermanentAssetMovementFromStowegeServices.cancel(id)
      .then((res) => {
        if (res.status === 200) {
  ...
  const printHandler = (id) => {
    setLoading(true);
    PermanentAssetMovementFromStowegeServices.printById(id)
      .then(res => {
        if (res.status === 200) {
