...
const getListSlice = createSlice({
  name: "PermanentAssetMovementFromStowege",
  initialState,
  reducers: {
...
// Reducer
const PermanentAssetMovementFromStowegeReducer = getListSlice.reducer;
export default PermanentAssetMovementFromStowegeReducer;