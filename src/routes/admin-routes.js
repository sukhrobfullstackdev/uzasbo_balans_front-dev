...
const routes = [
  ...
  { path: '/ResponsiblePerson/add', exact: true, name: 'AddResponsiblePerson', component: UpdateResponsiblePerson, role: 'ResponsiblePersonInsert' },
  { path: '/ResponsiblePerson/edit/:id', exact: true, name: 'EditResponsiblePerson', component: UpdateResponsiblePerson, role: 'ResponsiblePersonEdit' },
  ...
  { path: '/CurrencyCourse/add', exact: true, name: 'AddCurrencyCourse', component: UpdateCurrencyCourse, role: 'UserInsert' },
  { path: '/CurrencyCourse/edit/:id', exact: true, name: 'EditCurrencyCourse', component: UpdateCurrencyCourse, role: 'UserEdit' },
