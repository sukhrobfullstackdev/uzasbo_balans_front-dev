...
const baseUrl = "PermanentAssetMovementFromStowege/";

const PermanentAssetMovementFromStowegeServices = {
  getList(payload) {
...
export default PermanentAssetMovementFromStowegeServices;